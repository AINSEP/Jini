...
// "`examples/minimal-host` installs only packed `@injini/*` tarballs, OD-noun/
...
//   root, must: pack every `@injini/*` dependency of examples/minimal-host into
...
describe('milestone 1 gate N — health-boot from packed @injini/* tarballs', () => {
