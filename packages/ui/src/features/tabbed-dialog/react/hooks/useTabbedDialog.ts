...
export interface UseTabbedDialogParams<T extends TabbedDialogTabMeta> {
  tabs: readonly T[];
   ...
   *  product-specific behavior. Omit to disable Escape-to-close and render
...
export interface TabbedDialogController {
 ...
 */
export function useTabbedDialog<T extends TabbedDialogTabMeta>({
  tabs,
  initialActiveTabId,
...
}: UseTabbedDialogParams<T>): TabbedDialogController {
