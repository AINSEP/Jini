/**
 * @module react/mcp-ui/McpUiSurfaceCard
 *
...
import type { McpUiToolCallHandler } from './useMcpUiHost.js';
import { parseUIResource, readPreferredFrameSize, type UIResource } from '../../features/mcp-ui/resource.js';
import { registerExtEventRenderer, type ExtEventRenderProps } from '../chat/ext-event-renderer-registry.js';
import { useT } from '../chat/hooks/context.js';
