...
Per `ADS-memory/reports/jini-port/START-HERE.md`/dispatch brief: this is a genuinely new
...
reporters per `ADS-memory/reports/jini-port/skills/fixing-open-design.md` Phase 6.5):
