 ...
 * `@injini/media`, not a new one introduced here.
 */
...
export interface MediaGenerationRequest {
  ...
  /** Catalog id (e.g. `dall-e-3`, `gpt-4o-mini-tts`) — must be registered in `@injini/media`'s catalogue for the given surface/audioKind. */
  readonly model: string;
