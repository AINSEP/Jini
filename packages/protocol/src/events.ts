...
export type RunAgentPayload =
   ...
   * `@injini/agui`'s generalization of OD's `pipeline_stage_started`/`pipeline_stage_completed`
   ...
   * problem). Added for `@injini/agui`'s generalization of OD's `genui_surface_request`/
