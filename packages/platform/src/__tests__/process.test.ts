...
describe('@injini/platform — process — createProcessStampArgs', () => {
...
describe('@injini/platform — process — readFlagValue', () => {
...
describe('@injini/platform — process — readProcessStamp / readProcessStampFromCommand', () => {
...
describe('@injini/platform — process — matchesProcessStamp / matchesStampedProcess', () => {
...
describe('@injini/platform — process — spawnBackgroundProcess', () => {
...
describe('@injini/platform — process — spawnLoggedProcess', () => {
...
describe('@injini/platform — process — isProcessAlive', () => {
...
describe('@injini/platform — process — waitForProcessExit', () => {
...
describe('@injini/platform — process — listProcessSnapshots (POSIX)', () => {
...
describe('@injini/platform — process — listProcessSnapshots (Windows)', () => {
...
describe('@injini/platform — process — collectProcessTreePids', () => {
...
describe('@injini/platform — process — stopProcesses', () => {
