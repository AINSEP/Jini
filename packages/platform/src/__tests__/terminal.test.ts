...
describe('@injini/platform — terminal — spawnHelperCandidatePaths', () => {
  ...
  it('uses the real require.resolve-based default resolver, whichever way it resolves in this workspace', () => {
    ...
    // a real dependency (e.g. @injini/daemon, added 2026-07-21), not on anything this package or
    ...
    // @injini/daemon added node-pty), this asserts the real default resolver's behavior is
...
describe('@injini/platform — terminal — ensureSpawnHelperExecutable', () => {
...
describe('@injini/platform — terminal — resolveShell', () => {
...
describe('@injini/platform — terminal — createTerminalService lifecycle', () => {
...
describe('@injini/platform — terminal — data flow, buffering, and exit', () => {
...
describe('@injini/platform — terminal — shutdownActive', () => {
