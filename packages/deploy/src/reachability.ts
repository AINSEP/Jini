...
import { assertSafePublicUrl, AssetCacheError, createValidatingLookup } from '@injini/platform';
 ...
 * shape `@injini/platform`'s asset-cache solves for a caller-supplied media URL.
