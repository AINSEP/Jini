...
import { createFakeSourceConfigDependencies, createFakeSourceConfigPort } from '../../source-config-list/dependencies.js';
import type { SourceConfigItem } from '../../source-config-list/types.js';
