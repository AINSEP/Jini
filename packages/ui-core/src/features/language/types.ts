 ...
 */
/** One selectable locale. Defined here rather than beside the menu component
 *  that renders it: it is plain data, and both the settings tab and
 *  `@jini-ai/ui`'s `LanguageMenu` need the same shape. */
