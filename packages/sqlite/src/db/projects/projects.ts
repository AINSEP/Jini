 ...
 * it didn't block `conversations`: `@jini-ai/sqlite` is a generic *optional* storage adapter any
 * consumer may use, not the kernel itself (`@jini-ai/core`/`@jini-ai/daemon` know nothing about this
