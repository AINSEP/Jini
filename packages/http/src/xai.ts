 ...
 * concept `@jini-ai/http` has no business modeling. This port checks only "is an xAI OAuth account
...
function defaultInternalErrorSink(context: XaiInternalErrorContext): void {
  ...
  console.error(`[@jini-ai/http] internal error (xai/${context.source}, correlationId=${context.correlationId})`, context.error);
}
