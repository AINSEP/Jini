 ...
 * in `@jini-ai/http` — this package has zero AI-provider knowledge anywhere
 ...
 * This module is the `@jini-ai/http` half of that split: request parsing,
...
function defaultInternalErrorSink(context: ModelProxyInternalErrorContext): void {
  ...
  console.error(`[@jini-ai/http] internal error (model-proxy/${context.provider}, correlationId=${context.correlationId})`, context.error);
}
