...
import { StorageError } from '@jini-ai/platform';
import { BlobStorageProvider } from '../index.js';

/**
 * Minimal in-memory fake of `@jini-ai/platform`'s `BlobStorage` port — no real filesystem I/O,
