 ...
 * over `messages` — built on `@injini/chat-core`'s
...
import type { ChatMessage, TodoItem } from '@injini/chat-core';
import { latestTodoWriteInputForPinnedCard, parseTodoWriteInput } from '@injini/chat-core';
