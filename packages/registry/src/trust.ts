 ...
 * (`@injini/protocol`'s `RegistrySignatureSchema`), closing the still-open half
 * of SEC-RB-005 per
...
import type { RegistryEntry, RegistrySignature } from '@injini/protocol';
 ...
 * `@injini/protocol`'s `RegistrySignatureSchema` does not itself define a
