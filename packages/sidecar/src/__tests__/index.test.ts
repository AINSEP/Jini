...
describe("@injini/sidecar — ipc-path", () => {
...
describe("@injini/sidecar — path boundary uses descriptor defaults, not hardcoded product constants", () => {
...
describe("@injini/sidecar — bootstrap", () => {
...
describe("@injini/sidecar — port allocation", () => {
...
describe("@injini/sidecar — json-file", () => {
...
describe("@injini/sidecar — jsonIpcError (direct — its only in-tree caller always passes a codeless SyntaxError)", () => {
...
describe("@injini/sidecar — JSON IPC", () => {
