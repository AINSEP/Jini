 ...
 * that comment was written, but now imports it from `@jini-ai/agentic` directly. It stays only so an
 * external `import type { CapabilityDef } from '@jini-ai/chat-core'` keeps compiling; new code
 * should import it from `@jini-ai/agentic`.
 */
