...
import { PAGE_CAPABILITIES, findCapability, findCapabilityInputError, type CapabilityDef } from '@jini/agentic';
 ...
 * `[...PAGE_CAPABILITIES, ...CHAT_CAPABILITIES]`). `@jini/agentic`'s own capability.test.ts
 ...
 * the `@jini/agentic` extraction split page-capabilities.ts out from under it. chat-capabilities.ts
