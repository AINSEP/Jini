...
- `ADS-memory/reports/jini-port/extraction-plan.md` — locked Jini architecture and package boundaries that this proposal must extend rather than bypass.
